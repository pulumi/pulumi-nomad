...
require (
	github.com/hashicorp/terraform-provider-nomad v1.4.21-0.20240531082318-be273db9f7a8
...
require (
	...
	github.com/hashicorp/nomad v1.8.0 // indirect
	github.com/hashicorp/nomad/api v0.0.0-20240528173817-28b82e4b2259 // indirect
