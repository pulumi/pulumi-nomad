...
require (
	github.com/hashicorp/terraform-provider-nomad v1.4.21-0.20250926135554-5dd2883eeae9
...
require (
	...
	github.com/hashicorp/nomad v1.10.5 // indirect
	github.com/hashicorp/nomad/api v0.0.0-20250410143434-48f304d0cab3 // indirect
