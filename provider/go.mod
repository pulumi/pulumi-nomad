...
require (
	github.com/hashicorp/terraform-provider-nomad v1.4.21-0.20241015153613-19607111edb0
...
require (
	...
	github.com/hashicorp/nomad v1.9.4 // indirect
	github.com/hashicorp/nomad/api v0.0.0-20241010071343-7ad36851ec02 // indirect
