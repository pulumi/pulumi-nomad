...
public final class CsiVolumeMountOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CsiVolumeMountOptionsArgs Empty = new CsiVolumeMountOptionsArgs();
    ...
    private CsiVolumeMountOptionsArgs() {}

    private CsiVolumeMountOptionsArgs(CsiVolumeMountOptionsArgs $) {
        this.fsType = $.fsType;
    ...
    public static Builder builder(CsiVolumeMountOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CsiVolumeMountOptionsArgs();
        }

        public Builder(CsiVolumeMountOptionsArgs defaults) {
            $ = new CsiVolumeMountOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CsiVolumeMountOptionsArgs build() {
            return $;
        }
    }
