...
public class Namespace extends com.pulumi.resources.CustomResource {
    ...
    public Namespace(java.lang.String name, @Nullable NamespaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nomad:index/namespace:Namespace", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Namespace(java.lang.String name, Output<java.lang.String> id, @Nullable NamespaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nomad:index/namespace:Namespace", name, state, makeResourceOptions(options, id), false);
    }
