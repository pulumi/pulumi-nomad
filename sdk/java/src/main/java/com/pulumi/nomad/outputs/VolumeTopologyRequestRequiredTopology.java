...
@CustomType
public final class VolumeTopologyRequestRequiredTopology {
    /**
    ...
    private VolumeTopologyRequestRequiredTopology() {}
    /**
     * @return Define attributes for the topology request.
     * 
     */
    ...
    public static Builder builder(VolumeTopologyRequestRequiredTopology defaults) {
    ...
    public static final class Builder {
        private Map<String,String> segments;
        public Builder() {}
        public Builder(VolumeTopologyRequestRequiredTopology defaults) {
        ...
        public Builder segments(Map<String,String> segments) {
            if (segments == null) {
              throw new MissingRequiredPropertyException("VolumeTopologyRequestRequiredTopology", "segments");
            }
