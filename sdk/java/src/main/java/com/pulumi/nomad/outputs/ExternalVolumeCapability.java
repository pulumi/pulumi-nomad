...
@CustomType
public final class ExternalVolumeCapability {
    /**
    ...
    public static Builder builder(ExternalVolumeCapability defaults) {
    ...
    public static final class Builder {
        ...
        private String attachmentMode;
        public Builder() {}
        public Builder(ExternalVolumeCapability defaults) {
        ...
        public Builder accessMode(String accessMode) {
            if (accessMode == null) {
              throw new MissingRequiredPropertyException("ExternalVolumeCapability", "accessMode");
            }
        ...
        public Builder attachmentMode(String attachmentMode) {
            if (attachmentMode == null) {
              throw new MissingRequiredPropertyException("ExternalVolumeCapability", "attachmentMode");
            }
