...
public class AclRole extends com.pulumi.resources.CustomResource {
     ...
     */
    public AclRole(String name, AclRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nomad:index/aclRole:AclRole", name, args == null ? AclRoleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private AclRole(String name, Output<String> id, @Nullable AclRoleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nomad:index/aclRole:AclRole", name, state, makeResourceOptions(options, id));
    }
