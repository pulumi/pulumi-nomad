...
@CustomType
public final class GetNamespaceConsulConfig {
    /**
    ...
    private GetNamespaceConsulConfig() {}
    /**
     * @return `([]string)` - The list of Consul clusters allowed to be used in this namespace.
     * 
     */
    ...
    public static Builder builder(GetNamespaceConsulConfig defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> denieds;
        public Builder() {}
        public Builder(GetNamespaceConsulConfig defaults) {
        ...
        public Builder alloweds(List<String> alloweds) {
            if (alloweds == null) {
              throw new MissingRequiredPropertyException("GetNamespaceConsulConfig", "alloweds");
            }
        ...
        public Builder default_(String default_) {
            if (default_ == null) {
              throw new MissingRequiredPropertyException("GetNamespaceConsulConfig", "default_");
            }
        ...
        public Builder denieds(List<String> denieds) {
            if (denieds == null) {
              throw new MissingRequiredPropertyException("GetNamespaceConsulConfig", "denieds");
            }
        ...
        public GetNamespaceConsulConfig build() {
            final var _resultValue = new GetNamespaceConsulConfig();
