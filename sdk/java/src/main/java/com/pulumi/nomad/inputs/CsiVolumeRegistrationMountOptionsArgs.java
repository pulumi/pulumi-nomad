...
public final class CsiVolumeRegistrationMountOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CsiVolumeRegistrationMountOptionsArgs Empty = new CsiVolumeRegistrationMountOptionsArgs();
    ...
    private CsiVolumeRegistrationMountOptionsArgs(CsiVolumeRegistrationMountOptionsArgs $) {
        this.fsType = $.fsType;
    ...
    public static Builder builder(CsiVolumeRegistrationMountOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CsiVolumeRegistrationMountOptionsArgs();
        }

        public Builder(CsiVolumeRegistrationMountOptionsArgs defaults) {
            $ = new CsiVolumeRegistrationMountOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CsiVolumeRegistrationMountOptionsArgs build() {
            return $;
        }
    }
