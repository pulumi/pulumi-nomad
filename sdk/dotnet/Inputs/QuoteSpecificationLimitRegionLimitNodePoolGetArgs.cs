...
namespace Pulumi.Nomad.Inputs
{
    ...
    public sealed class QuoteSpecificationLimitRegionLimitNodePoolGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("devices")]
        private InputList<Inputs.QuoteSpecificationLimitRegionLimitNodePoolDeviceGetArgs>? _devices;
        public InputList<Inputs.QuoteSpecificationLimitRegionLimitNodePoolDeviceGetArgs> Devices
        {
            get => _devices ?? (_devices = new InputList<Inputs.QuoteSpecificationLimitRegionLimitNodePoolDeviceGetArgs>());
            set => _devices = value;
        }
        ...
        [Input("storage")]
        public Input<Inputs.QuoteSpecificationLimitRegionLimitNodePoolStorageGetArgs>? Storage { get; set; }

        public QuoteSpecificationLimitRegionLimitNodePoolGetArgs()
        {
        }
        public static new QuoteSpecificationLimitRegionLimitNodePoolGetArgs Empty => new QuoteSpecificationLimitRegionLimitNodePoolGetArgs();
    }
}
