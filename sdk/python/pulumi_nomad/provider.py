...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 ignore_env_vars: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.bool]]]] = None,
    ...
    def ignore_env_vars(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.bool]]]]:
        """
    ...
    def ignore_env_vars(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.bool]]]]):
...
class Provider(pulumi.ProviderResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["http_auth"] = None if http_auth is None else pulumi.Output.secret(http_auth)
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["httpAuth", "keyPem", "secretId"])
